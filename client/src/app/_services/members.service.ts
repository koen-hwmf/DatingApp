...
export class MembersService {
  ...
  getMembers(userParams: UserParams) {
    // Get response from cache at the key build query params values
    ...
    return this.getPaginatedResult<Member[]>(
      ...
      // store response in cache with key build from query params values
      map((res) => {
  ...
  getMember(username: string) {
    ...
    // return member from server if not found in cache
